...
- **훅(hooks):** `.claude/settings.json`이 `PreToolUse`/`PostToolUse` 훅 4개(`block-dangerous.sh`·`block-db-migration.sh`·`warn-breaking-change.sh`·`format-java.sh`)를 등록한다 — 목록·역할은 [`.claude/rules/README.md`](.claude/rules/README.md) Hooks 표가 SSOT
