...
- Java 주석: Swagger·`@Schema`와 중복 금지 — **Service/Support/Interceptor/Scheduler public 유스케이스는 메서드 위 `//` 역할 한 줄 필수**(facade·stub 포함) · 다단계는 `// 1.`+Why · Controller는 권한·검증만 — `.cursor/rules/spring-boot-java.mdc` Comments 절
