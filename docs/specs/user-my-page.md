...
> deferred: 회원 탈퇴 → [`user-account-withdrawal.md`](user-account-withdrawal.md) / `#48`
...
- 캘린더 연동 API
- 회원 탈퇴 → [`user-account-withdrawal.md`](user-account-withdrawal.md)(`#48`, Wave 2 Nice)로 위임
- `user_condition` CRUD
