...
- 멤버=join으로 `SCHEDULE_PENDING` 생성 → 일정 확인 → activate ACTIVE (**2026-08-19 `#114`** — 이전에는 일정 확인 후 join 한 번으로 바로 ACTIVE) · 방 안 API는 ACTIVE (전역 `canEnterRoom` 조건은 **2026-08-18 삭제**, `#113`)
