...
| #19 | 아니오 — Wave 3 **Must** (카카오 초대 공유 · 구 join 미리보기 주제 폐기) |
...
- 카카오 초대 공유 (#19)
- Redis·RTR (#4)
- join 전 미리보기 (이슈 미배정 · 구 #19) → Wave 2 **Out**
...
- [ ] 여행방 일정 조회 윈도우 (#37) · TERMINATED snapshot (#38) Must 완료
...
| TERMINATED·Pin 스케줄러 | #27 | 불필요 (Implemented · Closed) |
| 참여자 내보내기 | #20 | 불필요 |
...
| **2** | **#30** | #13 (#11·#12·#17·#37·#38 ✓) | #20, #26✓, #27✓ | join 미리보기 Out(이슈 미배정) · #21·#19 → Wave 3 |
...
**Nice 구분:** GitHub 라벨 없음 — Backlog **Nice** 목록 + Issue **비고** `분류: Wave N Nice` (#20 · #26 · #27). **Out**은 Backlog Out (join 전 미리보기 · 이슈 미배정). `Nice / Out` 혼용 금지.
