...
- provider별 토큰 검증 구조: [`005-auth-social-verifier-strategy.md`](005-auth-social-verifier-strategy.md) — Strategy + Registry
...
|------|------|
| 2026-06-30 | 안 B 확정 |
| 2026-07-22 | amend — 환경 A/B · Calendar도 302 금지 (platform · #44) |