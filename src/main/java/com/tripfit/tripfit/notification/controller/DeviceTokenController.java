...
public class DeviceTokenController {
   ...
   * <p>
   * ■ FE 유의사항 <br>
   * - 본인 기기의 FCM 등록 토큰을 서버에 저장하여 푸시 알림을 받을 수 있게 합니다. <br>
   * - 앱 실행 시 혹은 토큰 갱신 이벤트 발생 시 주기적으로 호출하세요.
   *
   * <p>
   * ■ BE 처리 <br>
   * - 이미 등록된 토큰이면 소유자 및 기기 플랫폼 정보를 갱신합니다. <br>
   * - 동일 토큰이 다른 유저의 소유로 등록되어 있었다면 현재 로그인한 본인 소유로 재할당(upsert)합니다.
   */
   ...
   * <p>
   * ■ FE 유의사항 <br>
   * - 로그아웃 직전에 본인 기기의 FCM 토큰을 해제하여 더 이상 알림이 오지 않도록 합니다.
   *
   * <p>
   * ■ BE 처리 <br>
